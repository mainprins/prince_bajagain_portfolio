...
import { CiBookmark, CiGrid41, CiLink, CiMonitor } from 'react-icons/ci'
        ...
        <div id="right-desktop" className='hidden md:flex gap-8 items-center justify-center'>
            <div id="navIcons"className='flex gap-5 relative items-center justify-center p-2 border border-stone-800 rounded-full'>
                ...
                <div id="right" className='flex gap-2'>
                    ...
                    <div id="right">
                        <button className='bg-linear-to-b from-stone-800 via-stone-700 hpver:from-stone-700 hover:via-stone-600 hover:to-stone-500 to-stone-600 transition-colors duration-500 text-stone-300 hover:text-stone-200 cursor-pointer rounded-full py-2 px-4 text-sm'>Book a call</button>
                    </div>
                </div>
                ...
                <div id="right" className='flex flex-col gap-4'>
                    <div id="one" className='flex gap-3 items-center w-50 hover:bg-stone-700 p-3 rounded-md cursor-pointer'>
                        <div id="left" className='bg-stone-700 p-2 border border-stone-500'>
                            <CiLink size={30}/>
                        </div>
                        <div id="right">
                            <div id="top" className='font-bold'>Links</div>
                            <div id="bottom" className='text-xs text-stone-400'>Socials and Profiles</div>
                        </div>
                    </div>
                    <div id="two" className='flex gap-3 items-center w-50 hover:bg-stone-700 p-3 rounded-md cursor-pointer'>
                         <div id="left" className='bg-stone-700 p-2 border border-stone-500'>
                            <CiMonitor size={30}/>
                         </div>
                        <div id="right">
                            <div id="top" className='font-bold'>Uses</div>
                            <div id="bottom" className='text-xs text-stone-400'>My gears and softwares</div>
                        </div>
                    </div>
                    <div id="three" className='flex gap-3 items-center w-50 hover:bg-stone-700 p-3 rounded-md cursor-pointer'>
                         <div id="left" className='bg-stone-700 p-2 border border-stone-500'>
                            <CiBookmark size={30}/>
                         </div>
                        <div id="right">
                            <div id="top" className='font-bold'>Guestbook</div>
                            <div id="bottom" className='text-xs text-stone-400'>Sign my wall</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="options">
                 <div id="left" className='p-3 border border-stone-950 hover:border-stone-600 rounded-full transition-all duration-500 bg-stone-800 hover:bg-stone-70 cursor-pointer text-xl'>
                        <CiGrid41 />
                    </div>
            </div>
